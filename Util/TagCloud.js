...
Ext.define('Util.TagCloud',{
  ...
  initComponent:function( ){
    ...
    this.addListener('show', this.delayedDraw, this);
    // this.addListener('activate', this.delayDraw, this);
    // this.addListener('afterrender', this.checkAndDraw , this);
    
    // this.store.addListener( 'load', this.checkAndDraw , this );
    this.store.addListener( 'refresh', this.checkAndDraw , this );
  ...
  checkAndDraw:function(){
    ...
    // if ( this.filter && !( this.isHierarchicallyHidden() || this.isHidden() ) && this.rendered ) {
