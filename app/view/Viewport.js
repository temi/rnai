Ext.define('RNAi.view.Viewport', {
  ...
  initComponent : function() {
    var store = Ext.data.StoreManager.lookup('RNAi.store.Classification'),
        hits = Ext.data.StoreManager.lookup('RNAi.store.Hits'),
        status = Ext.data.StoreManager.lookup('RNAi.store.Status'),
        viewport = this, queries = Ext.data.StoreManager.lookup('RNAi.store.Queries'),
        htmlHitRegionsStore = Ext.data.StoreManager.lookup('RNAi.store.HTMLHitRegions'),
        hitPanel;
    ...
    Ext.Ajax.request({
      ...
      success: function(response){
        viewport.down('container[title=Usage] panel').update(response.responseText)
      }
    })
